...
import 'package:careem_go/core/api/api_error/api_error_method.dart';
import 'package:careem_go/core/api/api_error/api_status_code.dart';
      ...
      case const (OfflineApiFailure):
        {
          return handleOfflineApiFailure(
              buildContext: buildContext,
              failure: failure as OfflineApiFailure,
              errorEntity: errorEntity);
        }
      default:
        {
